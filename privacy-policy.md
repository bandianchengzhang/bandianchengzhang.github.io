...
- **位置和天气信息**：当您使用天气相关功能时，我们会收集您的粗略位置信息（仅限城市或地区级别）以获取相应的天气数据。我们不会收集或存储您的精确地理位置坐标。位置信息仅用于通过 Apple WeatherKit 服务获取天气数据，以便为您提供个性化的天气提醒和建议。
...
- 我们不会访问您的通讯录、短信、通话记录
- 我们不会收集您设备上的其他应用数据
- 我们不会收集您的精确地理位置坐标，仅在您使用天气功能时收集城市或地区级别的粗略位置信息
...
### 3.5 天气功能和提醒
- 基于您的粗略位置信息（城市或地区级别）获取天气数据
- 根据天气变化为您提供个性化的友好提醒和建议
- 天气信息仅用于增强您的使用体验，不会用于其他商业目的
- 您可以随时在设置中关闭天气相关功能
...
- **天气功能控制**：您可以选择是否使用天气相关功能，应用不会在未获授权的情况下持续收集您的位置信息。
...
### 9.4 天气服务
- **WeatherKit**（Apple）：用于为您提供本地天气信息。WeatherKit 可能会根据您的粗略位置信息返回天气数据。WeatherKit 的数据处理遵循 Apple 的隐私政策，详见 [Apple 隐私政策](https://www.apple.com/cn/legal/privacy/)。
